...
define([
    ...
    describe("Standard Keyboard plugin", function () {
        var mockDoc = document.implementation.createDocument(null, 'html',null),
            emu,
            event,
            generateScancode,
            util;
        ...
        rootUtil.each([
            ...
            describe("for key with keyCode " + fixture.keyCode + " (" + fixture.keyName + ")", function () {
                describe("when a 'keydown' event fires", function () {
                    beforeEach(function () {
                        event = createEvent("keydown", fixture.keyCode, mockDoc);
                ...
                describe("when a 'keyup' event fires", function () {
                    beforeEach(function () {
                        event = createEvent("keyup", fixture.keyCode, mockDoc);
